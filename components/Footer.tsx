...
export default function Footer() {
  return (
    <footer className="bg-[#1D427A] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4 tracking-tight">Sanjay Devnani Projects</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/projects" className="text-slate-200 hover:text-white transition-colors">
                  Projects
                </Link>
              </li>
              <li>
          ...
          {/* Locations */}
          <div>
            <h3 className="text-lg font-semibold mb-4 tracking-tight">Locations</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/flats-in-chembur" className="text-slate-200 hover:text-white transition-colors">
                  Flats in Chembur
                </Link>
              </li>
              <li>
                <Link href="/2-bhk-in-chembur" className="text-slate-200 hover:text-white transition-colors">
                  2 BHK in Chembur
                </Link>
              </li>
              <li>
                <Link href="/flats-in-bandra" className="text-slate-200 hover:text-white transition-colors">
                  Flats in Bandra
                </Link>
              </li>
            </ul>
